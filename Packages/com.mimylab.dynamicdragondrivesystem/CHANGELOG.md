...
- コンポーネントアイコンを正式実装 (thanks ポテト @animekki)
- OtherMenu用コンポーネントは親子関係の移動をするのみに変更
...
- **Fixed**
  - DragonBondsのReinsInput保存バグ修正
  - ブレーキ入力閾値のデフォルト値を調整
  - VRモードでViveコン入力の強制表示(暫定)
  - メニューの表示調整(WIP)
...
- **Fixed**
  - CollisionDetectorが機能しなくなっていたのを修正
  - 高速飛行時の昇降操作チューニング

## [0.18.2] - 2024/12/18

- **Fixed**
  - 高速飛行中、ロール傾斜に応じて昇降量減衰するよう調整
...
- **Changed**
  OnInputMethodChanged()で利用可能な入力を増やす方式に変更
  - 各スクリプトの名称、メニュー階層を変更整理

- **Fixed**
  - ReinsInputLegacyの初期値とメニューが狂っていたのを修正

## [0.16.1] - 2024/7/22

- **Changed**
  - ドラゴンをテレポートさせるスクリプト名をPrefab名と合わせた

## [0.16.0] - 2024/7/21

- **Added**
  - 接触したドラゴンをテレポートさせるギミックを追加

- **Fixed**
  - VR HandleとVR Leverの不具合修正
  - 入力方法を減らしても機能するよう修正
...
- **Added**
  - VR HandleとVR Lever入力選択時にUI表示を追加
...
[0.21.2]: https://github.com/mimyquality/DynamicDragonDriveSystem/releases/tag/0.21.2
